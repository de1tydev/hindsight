...
| `sessionSummaryEnabled`                      | `false`                                               | Enables rolling session summary lifecycle when at least one summary consumption or update flag is enabled. With no consumption/update flag, the lifecycle remains inactive.                                                                                                                                 |
| `sessionSummaryStorePath`                    | `~/.openclaw/data/hindsight-session-summaries.sqlite` | Optional SQLite path for rolling session summaries.                                                                                                                                                                                                                                                         |
| `sessionSummaryEnrichRecallQuery`            | `false`                                               | Adds rolling summary context after the latest recall query while preserving `recallMaxQueryChars`. Auto-recall must still be enabled for this surface to call recall.                                                                                                                                       |
| `sessionSummaryEnrichRetainContext`          | `false`                                               | Adds rolling summary text to the retain extraction `context`, never to retained transcript content.                                                                                                                                                                                                         |
| `sessionSummaryInjectPrompt`                 | `false`                                               | Injects a separate `<hindsight_session_summary>` prompt block outside `<hindsight_memories>`. This can operate even when `autoRecall` is disabled.                                                                                                                                                          |
| `sessionSummaryGeneratorProvider`            | —                                                     | Optional real generator request. OpenClaw currently records the correct-course boundary and uses `FakeSessionSummaryGenerator` until a stable plugin-side LLM helper is planned.                                                                                                                            |
| `sessionSummaryGeneratorModel`               | —                                                     | Optional real generator model request. Currently no-op without a stable OpenClaw LLM helper.                                                                                                                                                                                                                |
| `sessionSummaryGeneratorBaseUrl`             | —                                                     | Optional real generator base URL request. Currently no-op without a stable OpenClaw LLM helper.                                                                                                                                                                                                             |
| `sessionSummaryGeneratorApiKeyEnv`           | `HINDSIGHT_LLM_API_KEY`                               | Environment variable name for the summary generator API key.                                                                                                                                                                                                                                                |
| `sessionSummaryReuseHindsightLlmConfig`      | `true`                                                | Reuse `llmProvider`, `llmModel`, and `llmBaseUrl` when summary-specific fields are unset.                                                                                                                                                                                                                   |
| `sessionSummaryUpdateEveryNTurns`            | —                                                     | Optional summary refresh cadence independent from `retainEveryNTurns`.                                                                                                                                                                                                                                      |
| `sessionSummaryMinUpdateEveryNTurns`         | `2`                                                   | Minimum summary refresh cadence; prevents per-turn summary LLM calls when `retainEveryNTurns` is `1`.                                                                                                                                                                                                       |
| `sessionSummaryTimeoutMs`                    | `20000`                                               | Timeout for bounded summary generation/update work.                                                                                                                                                                                                                                                         |
| `sessionSummaryMaxInputChars`                | `16000`                                               | Maximum characters considered by summary generation.                                                                                                                                                                                                                                                        |
| `sessionSummaryMaxOutputChars`               | `2000`                                                | Maximum rendered summary characters.                                                                                                                                                                                                                                                                        |
| `sessionSummaryMaxRecallQueryChars`          | `800`                                                 | Budget for summary-derived recall query text.                                                                                                                                                                                                                                                               |
| `sessionSummaryRecallQueryBudgetRatio`       | `0.25`                                                | Maximum fraction of the summary input budget usable for recall query text.                                                                                                                                                                                                                                  |
| `sessionSummaryMaxPromptInjectChars`         | `1200`                                                | Budget for prompt-injected summary context.                                                                                                                                                                                                                                                                 |
| `sessionSummaryMaxRetainContextChars`        | `1200`                                                | Budget for retain context summary text.                                                                                                                                                                                                                                                                     |
| `sessionSummaryMinLatestQueryReserveChars`   | `400`                                                 | Latest-query reserve when trimming summary inputs.                                                                                                                                                                                                                                                          |
| `sessionSummaryDropCompletedTodosAfterTurns` | `20`                                                  | Age after which completed todos may be dropped from summaries.                                                                                                                                                                                                                                              |
