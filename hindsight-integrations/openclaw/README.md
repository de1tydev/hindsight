...
| `sessionSummaryEnabled`                      | `false`                                               | Enables the rolling session summary lifecycle for configured summary updates and recall-query enrichment.                                                                                                                                                                                                   |
...
| `sessionSummaryEnrichRecallQuery`            | `false`                                               | Adds rolling summary context after the latest recall query while preserving `recallMaxQueryChars`. Auto-recall must still be enabled.                                                                                                                                                                       |
| `sessionSummaryGeneratorProvider`            | —                                                     | Optional summary generator provider hint. OpenClaw delegates generation to the configured Hindsight API; server-side routing decides the final LLM.                                                                                                                                                         |
| `sessionSummaryGeneratorModel`               | —                                                     | Optional summary generator model hint. OpenClaw delegates generation to the configured Hindsight API; server-side routing decides the final LLM.                                                                                                                                                            |
| `sessionSummaryGeneratorBaseUrl`             | —                                                     | Optional summary generator base URL hint. OpenClaw delegates generation to the configured Hindsight API; server-side routing decides the final LLM.                                                                                                                                                         |
