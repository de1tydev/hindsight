...
from hindsight_client_api.models.mental_model_search_response import MentalModelSearchResponse
from hindsight_client_api.models.search_mental_models_request import SearchMentalModelsRequest
...
class MentalModelsApi:
    ...
    async def search_mental_models(
        self,
        bank_id: StrictStr,
        search_mental_models_request: SearchMentalModelsRequest,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param bank_id: (required)
        :type bank_id: str
        :param search_mental_models_request: (required)
        :type search_mental_models_request: SearchMentalModelsRequest
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._search_mental_models_serialize(
            bank_id=bank_id,
            search_mental_models_request=search_mental_models_request,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def search_mental_models_with_http_info(
        self,
        bank_id: StrictStr,
        search_mental_models_request: SearchMentalModelsRequest,
        authorization: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MentalModelSearchResponse]:
        """Search mental models
    ...
    @validate_call
    async def search_mental_models_without_preload_content(
        self,
        bank_id: StrictStr,
        search_mental_models_request: SearchMentalModelsRequest,
        authorization: Optional[StrictStr] = None,
    ...
    def _search_mental_models_serialize(
        self,
        bank_id,
        search_mental_models_request,
        authorization,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if search_mental_models_request is not None:
            _body_params = search_mental_models_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/mental-models/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
