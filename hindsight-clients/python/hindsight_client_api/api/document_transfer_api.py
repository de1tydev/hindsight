...
class DocumentTransferApi:
    ...
    def _download_file_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/default/files/download/{key}',
    ...
    def _export_documents_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/document-transfer/export',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def export_documents_sync_removed(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        """(Deprecated) Export documents (removed — use POST .../document-transfer/export)
        ...
        **Removed.** The synchronous whole-bank export loaded the entire bank into memory and held a database connection for the full request, which could exhaust memory and take down the shared API on large banks. Use the asynchronous POST /v1/default/banks/{bank_id}/document-transfer/export instead: it returns an operation_id, runs the export in the background, and exposes a download URL on completion.
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /v1/default/banks/{bank_id}/document-transfer is deprecated.", DeprecationWarning)

        _param = self._export_documents_sync_removed_serialize(
            bank_id=bank_id,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def export_documents_sync_removed_with_http_info(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def export_documents_sync_removed_without_preload_content(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _export_documents_sync_removed_serialize(
        self,
        bank_id,
        authorization,
        _request_auth,
